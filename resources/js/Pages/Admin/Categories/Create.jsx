...
export default function Create({ parents, usedFeaturedOrders = [], usedHomeOrders = [] }) {
    const { data, setData, post, processing, errors } = useForm({
        ...
        is_featured: false,
        featured_order: 0,
        show_products_on_home: false,
        home_order: 0,
    });

    useEffect(() => {
        if (data.name) {
            setData('description', `${data.name} Price In Bangladesh`);
        }
    }, [data.name]);
                ...
                <div className="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div className="p-6 bg-white border-b border-gray-200">
                        ...
                        <form onSubmit={submit} encType="multipart/form-data">
                                ...
                                <div className="space-y-4">
                                    ...
                                    {data.is_featured && (
                                        <div className="ml-6">
                                            ...
                                            <div className="text-xs text-gray-500 mt-1">
                                                Already used orders: <span className="font-semibold">{usedFeaturedOrders.sort((a,b)=>a-b).join(', ') || 'None'}</span>
                                            </div>
                                    ...
                                    {data.show_products_on_home && (
                                        <div className="ml-6">
                                            ...
                                            />
                                            <div className="text-xs text-gray-500 mt-1">
                                                Already used orders: <span className="font-semibold">{usedHomeOrders.sort((a,b)=>a-b).join(', ') || 'None'}</span>
                                            </div>
                            ...
                            <div className="mb-4">
                                <InputLabel htmlFor="image" value="Cover Photo" />
                                <input
                                    id="image"
                                    type="file"
