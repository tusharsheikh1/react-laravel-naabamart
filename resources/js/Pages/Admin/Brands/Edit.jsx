            ...
            <div className="max-w-2xl mx-auto">
                <div className="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div className="p-6 bg-white border-b border-gray-200">
                        <h2 className="text-xl font-semibold mb-6">Edit Brand</h2>
                        ...
                        <form onSubmit={submit} encType="multipart/form-data">
                            ...
                            {/* Image Upload */}
                            <div className="mb-4">
                                <InputLabel htmlFor="image" value="Brand Logo" />
                                {brand.image && (
                                    <div className="mb-2">
                                        <img src={`/storage/${brand.image}`} alt="Current" className="h-20 w-auto object-contain rounded border" />
                                    </div>
                                )}
                                <input
                                    id="image"
