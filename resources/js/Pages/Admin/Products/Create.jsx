...
export default function Create({ categories, brands, authors, publications, colors, sizes }) {
    ...
    // Helper to display name in tags
    ...
    // --- Variant Logic ---
    const addVariant = () => {
        setData('variants', [...data.variants, { color_id: '', size_id: '', stock_quantity: 0, price_adjustment: 0 }]);
    };
            ...
            <form onSubmit={submit} encType="multipart/form-data" className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="lg:col-span-2 space-y-6">
                    ...
                    <div className="bg-white p-6 shadow-sm rounded-lg border border-gray-100">
                        <h3 className="text-lg font-semibold text-gray-800 mb-4 pb-2 border-b">Product Details</h3>
                        
                        <div className="space-y-4">
                            <div>
                                <InputLabel value="Product Name" />
                                <TextInput value={data.name} onChange={e => setData('name', e.target.value)} className="w-full mt-1" required placeholder="Ex: Wireless Headphones" />
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <select value={data.type} onChange={e => setData('type', e.target.value)} className="w-full mt-1 border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                ...
                                <div>
                                    <InputLabel value="SKU (Stock Keeping Unit)" />
                                    <TextInput value={data.sku} onChange={e => setData('sku', e.target.value)} className="w-full mt-1" placeholder="Ex: W-HEAD-001" />
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <textarea value={data.short_description} onChange={e => setData('short_description', e.target.value)} className="w-full mt-1 border-gray-300 rounded-md shadow-sm" rows="3" placeholder="Brief summary for listings..." />
                            </div>
                            <div>
                                <InputLabel value="Full Description" />
                                <textarea value={data.description} onChange={e => setData('description', e.target.value)} className="w-full mt-1 border-gray-300 rounded-md shadow-sm" rows="6" placeholder="Detailed product information..." />
                            </div>
                        </div>
                    </div>
                        ...
                        {data.type === 'digital' && (
                            <div className="space-y-4">
                                <div className="p-4 border border-dashed border-gray-300 rounded-lg bg-gray-50 text-center">
                                    <InputLabel value="Upload Digital File" />
                    ...
                    <div className="bg-white p-6 shadow-sm rounded-lg border border-gray-100">
                        ...
                        <div className="space-y-4">
                            <div>
                                <InputLabel value="Main Thumbnail (Required)" />
                                <input type="file" onChange={e => setData('thumbnail', e.target.files[0])} className="mt-1 block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-indigo-50 file:text-indigo-700 hover:file:bg-indigo-100" accept="image/*" />
                ...
                <div className="space-y-6">
                    ...
                    {/* 5. Organization (Multi-select Categories) */}
                    <div className="bg-white p-6 shadow-sm rounded-lg border border-gray-100">
                    ...
                    {/* 6. Pricing & Shipping (Tk Currency) */}
                    <div className="bg-white p-6 shadow-sm rounded-lg border border-gray-100">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="flex gap-2">
                                <div className="flex-1">
                                    ...
                                    <TextInput type="number" value={data.cost_price} onChange={e => setData('cost_price', e.target.value)} className="w-full mt-1" placeholder="0.00" />
                                    <InputError message={errors.cost_price} className="mt-1" />
                                </div>
                                <div className="flex-1">
                                    <InputLabel value="Reg. Price (Tk)" />
                                    <TextInput type="number" value={data.price} onChange={e => setData('price', e.target.value)} className="w-full mt-1" placeholder="0.00" />
                            ...
                            <div className="flex gap-2">
                                ...
                                <div className="flex-1">
                                    ...
                                    <TextInput type="number" value={data.discount_value} onChange={e => setData('discount_value', e.target.value)} className="w-full mt-1" placeholder="0" />
                                </div>
                            </div>
                    ...
                    <div className="bg-white p-6 shadow-sm rounded-lg border border-gray-100">
                         <div className="space-y-4">
                            <div>
                                ...
                                <select className="w-full mt-1 border-gray-300 rounded-md shadow-sm">
